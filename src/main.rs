...
fn main() {
    ...
    if command == "print.rs" {
        ...
        closures::run();
    } else if command == "fn_traits.rs" {
        fn_traits::run();
    } else if command == "iterator.rs" {
        iterator::run();
    } else if command == "smart_pointers_a.rs" {
        smart_pointers_a::run();
    } else if command == "smart_pointers_b.rs" {
    ...
    } else if command == "smart_pointers_e.rs" {
        smart_pointers_e::run();
    } else {
